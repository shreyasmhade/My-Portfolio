        ...
        >
          ...
          <motion.div className="space-y-8 order-2 lg:order-1" variants={itemVariants}>
            ...
            >
              ...
              performant web experiences with React.js, Next.js, and the MERN stack.
            </motion.p>
            ...
            <motion.div className="flex flex-col sm:flex-row gap-4 pt-2" variants={itemVariants}>
              <motion.button
                ...
                className="group bg-gradient-to-r from-emerald-500 to-blue-600 text-white px-8 py-4 rounded-xl font-semibold text-lg shadow-lg hover:shadow-xl transition-all flex items-center justify-center gap-3"
          ...
          {/* Profile Image */}
          <motion.div className="relative order-1 lg:order-2 flex justify-center lg:justify-end" variants={itemVariants}>
            <motion.div
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-emerald-400 to-blue-500 rounded-3xl blur-xl opacity-20 -z-10 scale-105" />
          </motion.div>

          {/* Availability Badge */}
          <motion.div
            className="absolute -bottom-4 left-1/2 transform -translate-x-1/2 lg:left-auto lg:-bottom-6 lg:right-6 bg-white px-5 py-2.5 rounded-full shadow-lg border border-gray-200 flex items-center gap-2"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 1, duration: 0.6 }}
          >
            <div className="w-2.5 h-2.5 bg-emerald-500 rounded-full animate-pulse" />
            <span className="text-sm font-semibold text-gray-700">Available for Freelance</span>
          </motion.div>
        </motion.div>
      </div>
    </section>
